---
title: "Version 2: 2 clusters; Fix cluster label switching; U,V re-parameterization"
output: pdf_document
---
...
```{r JAGS}
jags.file <- file.path(working.dir, "model_v2_uv_unif_fix.jags")
...
s <- summary(window(samps, start=5001))
#effectiveSize(window(samps, start=5001))
pdf(file.path(working.dir, "trace-plots-uv-unif-fix-c5.pdf"))
plot(samps)
dev.off()
```
