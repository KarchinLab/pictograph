---
title: "Version 2: 2 clusters; Fix cluster label switching \\ a,b; ensure w in [0,1]; 5 chains"
output: pdf_document
---
...
```{r JAGS}
jags.file <- file.path(models.dir, "v2_ab.jags")
...
s <- summary(samps)
dir.create(file.path(working.dir, "trace"), showWarnings = F)
pdf(file.path(working.dir, "trace", paste0(runName, "_trace.pdf")))
plot(samps)
dev.off()
```
