---
title: "Version 1: U,V re-parameterization"
output: pdf_document
---
...
library(coda)
library(MCMCpack)
working.dir <- "~/Dropbox/Wood-Collab-Progression/clustering/v1"
```
...
```{r JAGS}
jags.file <- file.path(working.dir, "model_uv.jags")
...
pdf(file.path(working.dir, "trace-plots-uv.pdf"))
plot(samps)
dev.off()
```
