...
We can also visualize the posterior probabilities of mutation cluster assignments. In this toy example, there is high concordance of the cluster assignments of mutations across the MCMC chain.  
...
```{r ensemble-tree}
am_chain <- lapply(filtered_trees, edgesToAmLong)
