...
Next, we enumerate this constrained tree space, and apply a filtered based on the Sum Condition. The `sum_filter_thresh` option constrains the
maximum sum of child node CCF can exceed parent node CCF. The default of `sum_filter_thresh` is 0.2.
